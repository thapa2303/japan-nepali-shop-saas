...
export function ShopHero({ shop }: ShopHeroProps) {
  ...
  const todayHours = Array.isArray(shop.openingHours)
    ? shop.openingHours.find((h) => h.dayOfWeek === today)
    : undefined
            ...
            <div className="hidden sm:flex gap-2 pb-2">
              {shop.contactWhatsapp && (
                <Button variant="outline" size="sm" asChild>
                  <a href={`https://wa.me/${shop.contactWhatsapp.replace(/[^0-9]/g, "")}`} target="_blank" rel="noopener noreferrer">
        ...
        <div className="mt-6 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="flex items-start gap-3 p-4 rounded-lg bg-secondary/50">
            ...
            <div>
              ...
              {!todayHours ? (
                <p className="text-sm text-muted-foreground mt-0.5">Hours unavailable</p>
              ) : todayHours.isClosed ? (

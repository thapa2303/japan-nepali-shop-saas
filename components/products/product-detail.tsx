...
import { getProductById, getProductsByShopId } from "@/lib/mock-data/products"
import { getShopBySlug, getShopById } from "@/lib/mock-data/shops"
...
export function ProductDetailClient({ productId, shopSlug }: ProductDetailClientProps) {
  ...
  const { addItem, updateQuantity, getItemQuantity, openCart } = useCart()
  ...
  const relatedProducts = getProductsByShopId(shop.id)
